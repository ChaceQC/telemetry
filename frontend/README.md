...
遥测前端使用 React、TypeScript、Vite 和 npm 构建。当前阶段提供可运行的控制台骨架、基础导航、总览首屏、健康检查 API client 和环境变量示例。

## 环境要求

- 使用 Node.js `24.13.0` LTS，版本固定在 `.node-version` 和 `package.json` 的 `engines` 中。
