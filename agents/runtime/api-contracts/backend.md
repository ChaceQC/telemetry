...
- Alert Rules 实现位于 `backend/app/services/alerts.py`、`backend/app/repositories/alerts.py`、`backend/app/api/routes/alerts.py`，默认使用 `SqlAlchemyAlertRuleRepository`。
